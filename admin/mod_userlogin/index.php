...
?>
    ...
    <table class="table table-striped">
        ...
        <?php
        $listuser = mysqli_query($koneksidb, "SELECT  * from mst_user");
        $nourut = 1;
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="?modul=mod_userlogin&action=edit&id=<?= $list['id_user']; ?>" class="btn btn-primary">
                        <i class="bi bi-pencil-square"></i> Edit</a>
                    <a href="?modul=mod_userlogin&action=delete&id=<?= $list['id_user']; ?>" class="btn btn-danger">
